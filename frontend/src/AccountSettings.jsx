...
const displayEmail = isDemoUser ? "demo@example.com" : user?.email || "Not provided";
 const pageVariants = {
  ...
  const styles = {
    ...
    deleteButton: {
      borderColor: "rgba(239, 108, 108, 0.35)",
    ...
    avatarSelectorContainer: {
      ...
      maxWidth: "480px",
      width: "100%",
      boxShadow: "var(--shadow-lg), var(--glow-gold), inset 0 1px 0 rgba(255,255,255,0.05)",
  ...
  useEffect(() => {
    ...
    styleElement.textContent = `
      ...
      .avatar-hover:hover {
        ...
        box-shadow: var(--shadow-lg), var(--glow-gold-strong) !important;
      ...
      .avatar-option:hover {
        ...
        border-color: var(--gold) !important;
        background: rgba(245, 200, 120, 0.10) !important;
      }
...
<div className={`user-email ${theme}`}>{displayEmail}</div>
  ...
  className={`support-card ${theme}`}
    ...
    >
      <FiSettings size={32} color="var(--gold-bright)" style={{marginBottom: "18px", marginTop:"7px"}} />
      <div
...
>
  <span style={styles.supportIcon}>
    <MdNotificationsActive size={32} color="var(--gold-bright)" />
    ...
    >
      ...
      >
        ...
        <div style={styles.modalContent}>
          ...
          <p style={styles.modalText}>
            <strong>Technology:</strong> Powered by GROQ AI (Llama 3.3 70B) for intelligent, contextual responses rooted in ancient wisdom.
          </p>
        </div>
        <div style={styles.popupButtons}>
          <button
