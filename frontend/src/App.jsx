    ...
    <>
      ...
      <AnimatePresence mode="wait">
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/landing" element={<PageTransition><GeetaGPTLanding /></PageTransition>} />
          ...
          <Route
            ...
            element={
              <Layout>
                <PageTransition><BhagavadGitaBot /></PageTransition>
              </Layout>
            }
          />
          ...
          <Route
            ...
            element={
              <Layout>
                <PageTransition><NotificationSettings /></PageTransition>
              </Layout>
            }
          />
          <Route
  ...
  useEffect(() => {
    ...
    navigator.serviceWorker
      ...
      .then((registration) => {
        ...
        // Check for updates every 10 minutes (once a minute was overkill)
